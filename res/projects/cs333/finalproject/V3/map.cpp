...
void Map::addNextNum(Node* to_countFrom, int location )
{
    ...
    for(int i =0; i < (columns+location-1);i++)
        ...
        cout << "find DLdiagnol of:" << to_countFrom->spot <<endl;
        cout << "The spot of diagnol is " << downLDiagnol->spot << endl;

        if (downLDiagnol->data == -10)
        {
            cout << "find diagnol of:" << to_countFrom->spot <<endl;
            cout << "The spot of diagnol is " << downLDiagnol->spot << endl;
            cout << "The data of spot: " << downLDiagnol->spot << " is before we do anything: " << downLDiagnol->data << endl;
    ...
    for(int i =0; i < (columns+location+1);i++)
        ...
        cout << "find DownRdiagnol of:" << to_countFrom->spot <<endl;
        cout << "The spot of diagnol is " << downRDiagnol->spot << endl;

        if (downRDiagnol->data == -10)
        {
            cout << "find DRdiagnol of:" << to_countFrom->spot <<endl;
            cout << "The spot of diagnol is " << downRDiagnol->spot << endl;
            cout << "The data of spot: " << downRDiagnol->spot << " is before we do anything: " << downRDiagnol->data << endl;
    ...
    for(int i =0; i < (location-1-columns);i++)
        ...
        cout << "find upLdiagnol of:" << to_countFrom->spot <<endl;
        cout << "The spot of diagnol is " << upLDiagnol->spot << endl;

        if (upLDiagnol->data == -10)
        {
            cout << "find ULdiagnol of:" << to_countFrom->spot <<endl;
            cout << "The spot of diagnol is " << upLDiagnol->spot << endl;
            cout << "The data of spot: " << upLDiagnol->spot << " is before we do anything: " << upLDiagnol->data << endl;
    ...
    for(int i =0; i < (location+1-columns);i++)
        ...
        cout << "find UPRdiagnol of:" << to_countFrom->spot <<endl;
        cout << "The spot of diagnol is " << upRDiagnol->spot << endl;

        if (upRDiagnol->data == -10)
        {
            cout << "find Uppdiagnol of:" << to_countFrom->spot <<endl;
            cout << "The spot of diagnol is " << upRDiagnol->spot << endl;
            cout << "The data of spot: " << upRDiagnol->spot << " is before we do anything: " << upRDiagnol->data << endl;
    ...
    Node* down = first;
        ...
        down = down->next;
        cout << down->spot << endl;
         cout << "find down of :" << to_countFrom->spot <<endl;
        cout << "The spot of down is " << down->spot << endl;
        if (down->data == -10)
        {
            cout << "find down of is :" << to_countFrom->spot <<endl;
            cout << "The spot of down is " << down->spot << endl;
            cout << "The data of spot: " << down->spot << " is before we do anything: " << down->data << endl;
    ...
    Node* up = first;
        ...
        cout << "The spot of up is " << up->spot << endl;

        if (up->data == -10)
        {
            cout << "Spot to find up of is :" << to_countFrom->spot <<endl;
            cout << "The spot of up is " << up->spot << endl;
            cout << "The data of spot: " << up->spot << " is before we do anything: " << up->data << endl;
            up->data = to_countFrom->data +1;
            cout << "The data of spot: " << up->spot << " is now equal to: " << up->data << endl;
        }
