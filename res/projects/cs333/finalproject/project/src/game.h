...
class Game {
    public:
         ...
         */
        bool gameEnded( vector<int> finishLine,int spotCar1, int spotCar2, int spotCar3);
    ...
    private:
         ...
         */
        Map myMap;
        //Determine what round the game is in currently
        int rounds;
        // Determine what player will go next.
        int playerSelect;
        bool isGameEnded;
};
#endif
